...
4. **Content-model work:** when prose/metadata should live outside TypeScript but UI-driving data must stay typed, use the raw Markdown + typed registry pattern in `references/raw-markdown-typed-registry-content-model.md`.
